...
<meta name="description" content="خلاق،هنرمند،با استعداد،علاقمند به یادگیری و تجربه کردن">
...
<link href="/css/DefaultResume-RTL.css?v=qlQwDzoVqC4PLj8isn0ifgI_a80-YBZYt_ZWntb3ybY" rel="stylesheet">
    ...
    <link href="/css/Template/template16-RTL.css?v=gzWsgiJZxeeosXc4fp652SoHR751emfXu3ZzdkLdpUQ" rel="stylesheet" />
    <script>
        var options = {
            templateId: 18,
            newVars: {
...
<script>
    ...
    <div class="infoo-head">
        <label>اطلاعات تماس</label>
            ...
            <div class="contact-item contact__email">
                ...
                <span>ایمیل:</span>
                <span>bitirhdr79@gmail.com</span>
            </div>
    <div class="contact-item contact__mobile">
                ...
                <span>موبایل:</span>
                <span style="unicode-bidi:embed" dir="ltr">(&#x2B;۹۸)۹۲۲۸۰۶۲۵۵۱</span>
    </div>
                ...
                <span>وب سایت:</span>
                <span><label dir="ltr"><a rel="nofollow noreferrer" class="social-link" href="https://quera.ir/profile/bitirhdr79" target="_blank">ًQuera</a></label><span>
                <span><label dir="ltr"><a rel="nofollow noreferrer" class="social-link" href="https://github.com/bitarahdar" target="_blank">ًGithub</a></label><span>
                ...
                <span>آدرس:</span>
                <span>تهران، شهرک اندیشه فاز 1</span>
            </div>
</div>
                </div>
        ...
        <div class="property-item_body">
            <div class="bar-progress item-row w0">
                <ul class="history">
                        ...
                        <li>
                            <span>
                                <label>ارتباط با مشتری و فن بیان</label>
                                    <label class="grade">
                                        <small>60%</small>
                                            <i class=tik></i>
                                            <i class=tik></i>
                        ...
                        <li>
                            <span>
                                <label> زبان برنامه نویس جاوا</label>
                                    <label class="grade">
                                        <small>40%</small>
                                            <i class=tik></i>
                                            <i class=tik></i>
                    ...
                    <ul class="history">
                            ...
                            <li>
                                <div class="c100 p60 small">
                                    ...
                                    <div class="circle-progress__title">ارتباط با مشتری و فن بیان</div>
                                </div>
                            </li>
                            <li>
                ...
                <ul class="history">
                        ...
                        <li>
                            <span>
                                ...
                                <label dir="ltr">
                                <a rel="nofollow noreferrer" class="social-link" href="https://bitarahdar.github.io/index-en" target="_blank">
                                    رزومه انگلیسی
                                </a>
                                </label>
                            </span>
    ...
    <div class="property-item basic__about" data-section="About">
        ...
        <div class="property-item_body">
            <p class="about-us">
                خلاق،هنرمند،با استعداد،علامند به یادگیری و تجربه
            </p>
        </div>
    </div>
            ...
            <ul class="history multi-line">
                        <li class="853377">
                            ...
                            <h3 class="subtitle">
                                ...
                                <ul class="exp-desc">
                                            <li>فعالیت در بازار یابی</li>
                                            <li>تبلیغات اینترنتی</li>
                                            <li>اپراتور</li>
